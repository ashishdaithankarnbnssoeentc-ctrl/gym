 ...
 * 
 * Handles membership lifecycle management with comprehensive security protections
 * Prevents privilege escalation, business logic abuse, and data manipulation
 */
